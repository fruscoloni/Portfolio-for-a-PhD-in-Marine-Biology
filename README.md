...
*(Insert your `global_trend.png` here: `![Global Trend](outputs/global_trend.png)`)*
...
*(Insert your `aquaculture_map.png` here: `![Aquaculture Map](outputs/aquaculture_map.png)`)*
